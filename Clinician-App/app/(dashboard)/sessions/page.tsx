...
export default function SessionsPage() {
  ...
  return (
    <div className="p-7 max-w-4xl mx-auto animate-fade">
      ...
      {/* Countdown Widget */}
      {view === 'upcoming' && (
        <div className="bg-psych-100/70 backdrop-blur-md border border-psych-200/50 rounded-3xl p-6 mb-8 text-black shadow-sm flex items-center gap-5 animate-spring relative overflow-hidden">
                ...
                <div className="pt-2 border-t border-gray-50 space-y-2.5 animate-spring">
                  ...
                  {viewSession.type.toLowerCase().includes('video') && (
                    <a 
                      ...
                      className="flex items-center justify-center gap-2 bg-psych-500 hover:bg-psych-600 text-white font-bold text-sm py-3 px-4 rounded-2xl shadow-lg shadow-psych-500/20 active:scale-95 transition-all w-full text-center"
                    >
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M23 7l-7 5 7 5V7z" />
                        <rect x="1" y="5" width="15" height="14" rx="2" ry="2" />
